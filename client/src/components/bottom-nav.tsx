...
export function BottomNav({ onAddClick }: BottomNavProps) {
  return (
    <div className="fixed bottom-0 left-0 right-0 bg-[#1A1F33] border-t border-white/5 px-4 pb-4 pt-3 z-50">
      <div className="flex items-center justify-around max-w-4xl mx-auto">
        ...
        <div className="flex gap-3 items-center">
          ...
          <button className="text-[#06b6d4] p-2 rounded-lg relative hover:bg-white/5">
            <FileText size={22} />
