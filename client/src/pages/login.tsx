...
function getErrorMessage(errorCode?: string, fallback?: string): string {
  switch (errorCode) {
    case "DB_UNAVAILABLE":
      return "Base de datos no disponible. El túnel SSH puede estar caído. Intenta en unos segundos.";
    case "ACCOUNT_LOCKED":
      return fallback || "Cuenta bloqueada temporalmente por múltiples intentos fallidos.";
    case "INVALID_CREDENTIALS":
      return "Correo o contraseña incorrectos.";
    case "SERVER_ERROR":
      return "Error interno del servidor. Intenta nuevamente.";
    default:
      return fallback || "Error al iniciar sesión. Intenta nuevamente.";
  }
}
